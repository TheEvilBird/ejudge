...
enum
{
  ...
  META_PROBLEM_CONFIG_SECTION_channel_time_limit,
  META_PROBLEM_CONFIG_SECTION_channel_real_time_limit,
  ...
  META_PROBLEM_CONFIG_SECTION_channel_cmd,
  ...
  META_PROBLEM_CONFIG_SECTION_channel_env,
